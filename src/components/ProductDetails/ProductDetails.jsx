...
<Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
     <Row>
          ...
          <h6 className="section-sub-title">SAC ITS, Surabaya</h6>
     ...
     <Row>
          ...
          <p className=" p-0 m-0"><span className="Review-Title">Raul Ilma Rajasa</span> <span className="text-success"><i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> <i className="fa fa-star"></i> </span> </p>
