     ...
     render() {
          ...
          <Row className="px-0 my-5">
               <Col className="p-2" lg={3} md={3} sm={6} xs={12}>
                    ...
                    <p>Subdirektorat Pengembangan Kewirausahaan dan Karir Gedung SAC, Kampus ITS Sukolilo, Surabaya 601111<br></br>
                    Email: techiro.indo@gmail.com
                    Phone Number: +62 – 812 5187 4796
                    </p>
                    <h5 className="footer-menu-title">SOCIAL LINK</h5>
                    <a href="https://www.linkedin.com/company/techiro?originalSubdomain=id"><i className="fab m-1 h4 fa-linkedin"></i></a>
                    <a href="https://www.instagram.com/techiro.id/"><i className="fab m-1 h4 fa-instagram"></i></a>
                    <a href="https://twitter.com/techiroindo"><i className="fab m-1 h4 fa-twitter"></i></a>
               </Col>
               ...
               <h5 className="footer-menu-title">DOWNLOAD APPS</h5>
                ...
                <a><img className="mt-2" src={Apple}  /></a><br></br>
                         ...
                         <Container fluid={true} className="text-center m-0 pt-3 pb-1 bg-dark">
                            <Container>
                                <Row>
                                    <h6 className="text-white">© Copyright 2023 by Techiro, All Rights Reserved</h6>
                                </Row>
                            </Container>
                        </Container> 
